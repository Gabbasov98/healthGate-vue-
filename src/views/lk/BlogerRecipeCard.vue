<template>
    <div class="recipe-card">
        <div class="recipe-card__dropdown" 
             v-if="currentRecipe.name === blogerRecipe.foodName+index"
             v-click-outside="clickOutsideDropdown">
            <div class="recipe-card__dropdown-inner">
                <a href="" class="recipe-card__dropdown-link">Редактировать</a>
                <a href="" class="recipe-card__dropdown-link">Отправить в черновики</a>
                <a href="" class="recipe-card__dropdown-link recipe-card__dropdown-link--red">Удалить</a>
            </div>
        </div>
        <div class="recipe-card__top">
            <div class="recipe-card__logo">
                <img :src="getImgUrl(blogerRecipe.avatarUrl)" alt="">
            </div>
            <div class="recipe-card__top-content">
                <div class="recipe-card__name">{{blogerRecipe.blogerName}}</div>
                <div class="recipe-card__profession">{{blogerRecipe.blogerProfession}}</div>
                <div class="recipe-card__tags" >
                    <a class="recipe-card__tag" v-for="tag in blogerRecipe.blogerTags" href="">#{{tag}}</a>
                </div>
            </div>
            <button class="recipe-card__top-btn" 
                    @click="openRecipeDropdown(blogerRecipe.foodName,index)">
                <img src="../../assets/images/markup-img/more.svg" alt="">
            </button>
        </div>
        <div class="recipe-card__img">
            <img :src="getImgUrl(blogerRecipe.foodUrl)" alt="">
        </div>
        ...
        <div class="recipe-card__subtitle">{{blogerRecipe.foodType}}</div>
        <div class="recipe-card__title">{{blogerRecipe.foodName}}</div>
        <div class="recipe-card__desc">{{blogerRecipe.foodDesc}}</div>
        <div class="recipe-card__info">
            <div class="recipe-card__info-item">
                <img src="../../assets/images/markup-img/time.png" alt="">
                <span>{{blogerRecipe.foodCookingDuration}}</span>
            </div>
            <div class="recipe-card__info-item">
                <img src="../../assets/images/markup-img/hat.svg" alt="">
                <span>{{blogerRecipe.foodDifficulty}}</span>
            </div>
            <div class="recipe-card__info-item">
                <img src="../../assets/images/markup-img/fire.svg" alt="">
                <span>{{blogerRecipe.foodKkal}} кал</span>
            </div>
        </div>
...
export default {
    ...
    methods: {
        getImgUrl(file) {
            return require(`../../assets/images/markup-img/${file}`)
        },
        openRecipeDropdown(name,idx){
            this.currentRecipe.name = name+idx
        },
